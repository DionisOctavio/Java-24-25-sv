...
//
        ...
        switch (arrayAction[0]) {
            case "USUARIO":
                String usuario = new UsuarioAction().execute(request, response);
                System.out.println(usuario);
                out.print(usuario);
                break;
            case "PELICULA":
                String pelicula = new PeliculaAction().execute(request, response);
                System.out.println(pelicula);
                out.print(pelicula);
                break;
            case "COMENTARIO":
                String comentario = new ComentarioAction().execute(request, response);
