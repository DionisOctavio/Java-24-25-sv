import services.GeneroAction;
import services.LibroAction;
...
//
        ...
        switch (arrayAction[0]) {
            case "LIBRO":
                String libro = new LibroAction().execute(request, response);
                System.out.println(libro);
                out.print(libro);
                break;
            case "GENERO":
                String genero = new GeneroAction().execute(request, response);
