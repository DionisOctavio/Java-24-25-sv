...
public class SingeltonConexion {
    private static volatile SingeltonConexion instance;
    ...
    public static SingeltonConexion getInstance() {
        if (instance == null) {
            synchronized (SingeltonConexion.class) {
                if (instance == null) {
                    instance = new SingeltonConexion();
                }
            }
        }
        return instance;
